		...
		<div class="row">
			<div class="col-md-12 offset-md-20">
				<div class="card paint-card">
					<div class="card-body">
						<p class="text-center fs-3" style="font-size: 2rem;">User Appointment</p>
						...
						<form class="row g-3" action="appAppointment" method="post">
							...
							<c:if test="${empty userObj }">
								<a href="user_login.jsp" class="col-md-3 col-mb-10 offset-md-4 btn btn-success">Submit</a>
							</c:if>

							<c:if test="${not empty userObj }">
								<button class="col-md-3 offset-md-4 btn btn-success">Submit</button>
							</c:if>
						</form>
					</div>
				</div>
