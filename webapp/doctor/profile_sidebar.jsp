    ...
    <div class="row">
      <div class="col-lg-3 mx-auto">
        <ul class="list-group">
          ...
          <a href="update_profile.jsp" class="list-group-item list-group-item-action">Upadate Profile</a>
          <a href="change_password.jsp" class="list-group-item list-group-item-action">Change Password</a>
          <a href="../doctorLogout" class="list-group-item list-group-item-action">Log out</a>
        </ul>
      </div>
</body>
